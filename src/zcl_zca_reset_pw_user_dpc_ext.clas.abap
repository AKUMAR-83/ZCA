CLASS zcl_zca_reset_pw_user_dpc_ext DEFINITION
  PUBLIC
  INHERITING FROM zcl_zca_reset_pw_user_dpc
  CREATE PUBLIC .
...
CLASS zcl_zca_reset_pw_user_dpc_ext IMPLEMENTATION.
  ...
  METHOD zca_sap_userset_create_entity.
    ...
    TRY.
        ...
        lo_pwreset->reset_password_user( ).
